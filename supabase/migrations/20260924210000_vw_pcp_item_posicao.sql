-- =====================================================================
-- GIFT WEB - vw_pcp expoe a POSICAO do item dentro do pedido
-- (item_posicao: 1, 2, 3... na ordem em que os produtos foram
-- lancados). O PCP usava o UUID do item para numerar "Item n/total",
-- entao a ordem era aleatoria. Coluna nova no FIM da lista; create or
-- replace preserva security_invoker e os grants da auditoria.
-- =====================================================================
