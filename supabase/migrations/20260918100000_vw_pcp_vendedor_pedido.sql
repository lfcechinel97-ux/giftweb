-- =====================================================================
-- GIFT WEB - vw_pcp ganha o vendedor do PEDIDO.
--
-- Fase de evolução visual do PCP: o card precisa mostrar um avatar do
-- vendedor responsável pelo pedido (com tooltip "Vendedor / Nome"). O
-- vendedor já existe -- sistema_pedidos.vendedor_id -- só não estava
-- exposto na view. Sem coluna nova, sem tabela nova.
-- =====================================================================
