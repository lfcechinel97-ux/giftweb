-- =====================================================================
-- GIFT WEB - vw_pcp expõe os anexos que já existem no PEDIDO.
--
-- Bug reportado: anexo adicionado na tela de criar/editar pedido
-- ("Anexar arte" por item, "Anexos Gerais" do pedido) não aparecia no
-- painel do PCP. Motivo: são guardados dentro do jsonb do pedido
-- (itens[].arteAnexoUrl e sistema_pedidos.anexos), e vw_pcp nunca
-- selecionava esses campos -- o PCP só conhecia sistema_producao_anexos
-- (tabela separada, alimentada pelo próprio PCP). Não são a mesma
-- fonte: este vw_pcp passa a expor as duas que já existem no pedido,
-- pra a seção "Anexos" do PCP mostrar tudo, sem duplicar nada.
-- =====================================================================
