              ...
              <div className="flex flex-col gap-3 w-full min-w-0">
                ...
                <div className="flex gap-2 items-stretch p-3 rounded-xl bg-secondary divide-x divide-border">
                  ...
                  <div className="flex-1 flex flex-col items-center gap-1 px-2">
                    <svg viewBox="0 0 512 512" className="w-6 h-6 text-muted-foreground" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M112.57 391.62c20.56 0 39.9-8.01 54.45-22.56l80.98-80.98c6.04-6.04 16.65-6.04 22.69 0l81.32 81.32c14.55 14.55 33.89 22.56 54.45 22.56h15.97l-102.6 102.6c-35.42 35.41-92.84 35.41-128.26 0L88.97 391.62h23.6z"/>
                      <path d="M112.57 120.38c20.56 0 39.9 8.01 54.45 22.56l80.98 80.98c6.27 6.27 16.42 6.27 22.69 0l81.32-81.32c14.55-14.55 33.89-22.56 54.45-22.56h23.6L327.01 17.38c-35.42-35.41-92.84-35.41-128.26 0L96.15 120.38h16.42z"/>
                      <path d="M494.62 198.99l-73.2-73.2h-14.96c-14.21 0-27.82 5.66-37.88 15.72l-81.32 81.32c-16.25 16.25-44.52 16.25-60.77 0l-80.98-80.98c-10.06-10.06-23.67-15.72-37.88-15.72H88.97l-73.2 73.2c-35.41 35.42-35.41 92.84 0 128.26l73.2 73.2h18.66c14.21 0 27.82-5.66 37.88-15.72l80.98-80.98c8.24-8.24 19.14-12.36 30.08-12.36 10.94 0 21.85 4.12 30.08 12.36l81.32 81.32c10.06 10.06 23.67 15.72 37.88 15.72h14.96l73.2-73.2c35.43-35.42 35.43-92.84.01-128.26z"/>
                    </svg>
